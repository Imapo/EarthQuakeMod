...
namespace RealisticEarthquake.Common.Utils
{
    ...
    public static class DebrisMaterials
    {
        ...
        public static readonly Dictionary<int, DebrisMaterial> SoftTiles = new()
        {
            ...
            // Самые твёрдые из "рыхлых" - песчаник, отвердевший песок подземных пустынь и лёд.
            [TileID.Sandstone] = new DebrisMaterial("Песчаник", TileID.Sandstone, ItemID.Sandstone, 1.6f, DustID.Sand),
            [TileID.HardenedSand] = new DebrisMaterial("Отвердевший песок", TileID.HardenedSand, ItemID.HardenedSand, 1.8f, DustID.Sand),
            [TileID.CorruptHardenedSand] = new DebrisMaterial("Порочный отвердевший песок", TileID.CorruptHardenedSand, ItemID.CorruptHardenedSand, 1.8f, DustID.CorruptPlants),
            [TileID.CrimsonHardenedSand] = new DebrisMaterial("Багровый отвердевший песок", TileID.CrimsonHardenedSand, ItemID.CrimsonHardenedSand, 1.8f, DustID.CrimsonPlants),
            [TileID.HallowHardenedSand] = new DebrisMaterial("Священный отвердевший песок", TileID.HallowHardenedSand, ItemID.HallowHardenedSand, 1.8f, DustID.HallowedPlants),
